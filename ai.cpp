...
void ai::place_point()
{
	...
	{ 2, 0, 0, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0, 2, 0, 0 },
	...
	for (int y = 0; y<17; y++){
		for (int x = 0; x<17; x++){
			...
			{
					point_board[y-1][x-1][0]+=three_two_WH; point_board[x+3][x+3][0]+=three_two_WH;
			}
			else if(temp == 3 && board[y-1][x - 1] == 2 && board[y][x] == 1 && board[x+3][x+3] == 0 && x!=0 && y!=0 && x<14 && y<14)//21110
			{
					point_board[y+3][x+3][0]+=three_one_WH;
			}
			else if(temp == 3 && board[y-1][x - 1] == 0 && board[y][x] == 1 && board[x+3][x+3] == 2 && x!=0 && y!=0 && x<14 && y<14)//01112
			{
